...
[![IaC Bazaar: live-tested](https://www.iac-bazaar.com/api/artifacts/gcp-artifact-registry/badge)](https://www.iac-bazaar.com/catalog/gcp-artifact-registry?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
...
```
curl -s https://www.iac-bazaar.com/api/artifacts/gcp-artifact-registry/verification
```

The receipt names every check that ran, when it ran, and the SHA-256 of the
archive it describes. Full detail: [www.iac-bazaar.com/catalog/gcp-artifact-registry](https://www.iac-bazaar.com/catalog/gcp-artifact-registry)

## Usage

```hcl
module "artifact_registry" {
  source  = "registry.terraform.io/CyberCoreSystems/artifact-registry/google"
  version = "~> 1.0"
...
- Terraform module 1.0.0, live-tested on IaC Bazaar: [Artifact Registry Repositories](https://www.iac-bazaar.com/catalog/gcp-artifact-registry?utm_source=syndication&utm_medium=readme&utm_campaign=artifact)
